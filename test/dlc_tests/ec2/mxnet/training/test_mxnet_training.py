...
from dlc_test_utils import CONTAINER_TESTS_PREFIX
...
def test_mxnet_standalone_gpu(mxnet_training, ec2_connection, gpu_only, ec2_instance_type):
    if dlc_test_utils.is_image_incompatible_with_instance_type(mxnet_training, ec2_instance_type):
        pytest.skip(
...
def test_mxnet_keras_gpu(mxnet_training, ec2_connection, gpu_only, ec2_instance_type):
    ...
    _, framework_version = dlc_test_utils.get_framework_and_version_from_tag(mxnet_training)
